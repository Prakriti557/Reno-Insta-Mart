...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "renoinstamart.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Reno Insta Mart</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Reno Insta Mart.<br>"
					...
					+ "<span class='greenText'>Reno Insta Mart</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
